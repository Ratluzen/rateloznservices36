...
// IMPORTANT for APK Build:
// When building the APK via GitHub Actions or locally for release,
...
export const authService = {
  ...
  updateProfile: (data: any) => api.put('/auth/profile', data), // NEW: Update profile & password
};
...
export const inventoryService = {
  ...
  add: (data: any) => api.post('/inventory', data), // expects { items: [] }
